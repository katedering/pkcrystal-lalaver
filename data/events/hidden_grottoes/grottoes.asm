...
; HIDDENGROTTO_ROUTE_32
	db 5, EVERSTONE, LEVEL_FROM_BADGES - 3
	dp MAREEP
	dp WOOPER
...
; HIDDENGROTTO_ILEX_FOREST
	db 4, LEAF_STONE, LEVEL_FROM_BADGES + 1
	dp PARAS
	dp ODDISH
	dp PSYDUCK
	dp PINECO
...
; HIDDENGROTTO_ROUTE_35
	db 4, SUN_STONE, LEVEL_FROM_BADGES + 3
	dp SNUBBULL
	dp JIGGLYPUFF
	dp YANMA
	dp DITTO
...
; HIDDENGROTTO_ROUTE_36
	db 7, FIRE_STONE, LEVEL_FROM_BADGES + 4
	dp STANTLER
	dp GROWLITHE
	dp VULPIX
	dp HOUNDOUR
...
; HIDDENGROTTO_CHERRYGROVE_BAY
	db 1, SHINY_STONE, LEVEL_FROM_BADGES + 1
	dp EXEGGCUTE
	dp SKIPLOOM
	dp SUNFLORA
	dp CORSOLA
...
; HIDDENGROTTO_VIOLET_OUTSKIRTS
	db 1, DUSK_STONE, LEVEL_FROM_BADGES + 2
...
; HIDDENGROTTO_RUINS_OF_ALPH
	db 13, MOON_STONE, LEVEL_FROM_BADGES + 1
	dp SANDSHREW
	dp NATU
	dp QUAGSIRE
	dp SMEARGLE
...
; HIDDENGROTTO_ROUTE_47
	db 7, SHINY_STONE, LEVEL_FROM_BADGES + 1
...
; HIDDENGROTTO_YELLOW_FOREST
	db 3, THUNDERSTONE, LEVEL_FROM_BADGES + 2
	dp LEDYBA
	dp SPINARAK
	dp MEOWTH
	dp PIKACHU
...
; HIDDENGROTTO_RUGGED_ROAD_NORTH
	db 2, FIRE_STONE, LEVEL_FROM_BADGES + 3
	dp GRAVELER
...
; HIDDENGROTTO_ROUTE_42
	db 6, DUSK_STONE, LEVEL_FROM_BADGES + 2
	dp MANKEY
	dp MARILL
	dp MACHOP
	dp GRAVELER
...
; HIDDENGROTTO_LAKE_OF_RAGE
	db 3, WATER_STONE, LEVEL_FROM_BADGES + 2
	dp PIDGEOTTO
	dp GIRAFARIG
	dp FARFETCH_D
	dp FLAAFFY
...
; HIDDENGROTTO_ROUTE_44
	db 2, LEAF_STONE, LEVEL_FROM_BADGES + 2
	dp TANGELA
	dp LICKITUNG
	dp GLIGAR
	dp ONIX
...
; HIDDENGROTTO_ROUTE_45
	db 2, MOON_STONE, LEVEL_FROM_BADGES + 2
	dp DONPHAN
	dp URSARING
	dp GLIGAR
	dp SKARMORY
...
; HIDDENGROTTO_ROUTE_46
	db 4, LEAF_STONE, LEVEL_FROM_BADGES + 2
	dp PHANPY
	dp TEDDIURSA
	dp ZUBAT
	dp DUNSPARCE
