...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 52, NINETALES, NEVERMELTICE, 252, FAKE_PERFECT_DVS, ABIL_NINETALES_ALOLAN_SNOW_CLOAK | NAT_SPD_UP_ATK_DOWN, FEMALE | ALOLAN_FORM
		db ICE_SHARD, DISARM_VOICE, EXTRASENSORY, HAIL
	db 51, CHANSEY, EVIOLITE, 252, FAKE_PERFECT_DVS, ABIL_BLISSEY_SERENE_GRACE | NAT_SDEF_UP_ATK_DOWN, FEMALE
		db FRESH_SNACK, TOXIC, HYPER_BEAM, COUNTER
	db 53, RAPIDASH, PINK_BOW, 252, FAKE_PERFECT_DVS, ABIL_RAPIDASH_GALARIAN_PASTEL_VEIL | NAT_SATK_UP_ATK_DOWN, FEMALE | GALARIAN_FORM
		db CONFUSION, DISARM_VOICE, AGILITY, SWIFT
	db 53, BUTTERFREE, SILVERPOWDER, 252, FAKE_PERFECT_DVS, ABIL_BUTTERFREE_TINTED_LENS | NAT_SATK_UP_ATK_DOWN, FEMALE
		db PSYBEAM, BUG_BITE, SHADOW_BALL, SWIFT
	db 54, CORSOLA, BRIGHTPOWDER, 252, FAKE_PERFECT_DVS, ABIL_CORSOLA_REGENERATOR | NAT_SDEF_UP_SPD_DOWN, FEMALE
		db CURSE, RECOVER, PROTECT, SCALD
	db 55, BELLOSSOM, BIG_ROOT, 252, FAKE_PERFECT_DVS, SHINY_MASK | ABILITY_1 | NAT_SATK_UP_ATK_DOWN, FEMALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 77, NINETALES, NEVERMELTICE, 252, FAKE_PERFECT_DVS, ABIL_NINETALES_ALOLAN_SNOW_CLOAK | NAT_SPD_UP_ATK_DOWN, FEMALE | ALOLAN_FORM
		db AURORA_BEAM, HAIL, DAZZLINGLEAM, WILL_O_WISP
	db 76, BLISSEY, ASSAULT_VEST, 252, FAKE_PERFECT_DVS, ABIL_BLISSEY_SERENE_GRACE | NAT_SDEF_UP_ATK_DOWN, FEMALE
		db WATER_PULSE, THUNDERBOLT, ICE_BEAM, FLAMETHROWER
	db 78, RAPIDASH, PINK_BOW, 252, FAKE_PERFECT_DVS, ABIL_RAPIDASH_GALARIAN_PASTEL_VEIL | NAT_SATK_UP_ATK_DOWN, FEMALE | GALARIAN_FORM
		db HYPER_BEAM, DAZZLINGLEAM, PSYCHIC_M, CALM_MIND
	db 78, BUTTERFREE, SILVERPOWDER, 252, FAKE_PERFECT_DVS, ABIL_BUTTERFREE_TINTED_LENS | NAT_SATK_UP_ATK_DOWN, FEMALE
		db BUG_BUZZ, HEALINGLIGHT, AIR_SLASH, SHADOW_BALL
	db 79, CORSOLA, BRIGHTPOWDER, 252, FAKE_PERFECT_DVS, ABIL_CORSOLA_REGENERATOR | NAT_SDEF_UP_SPD_DOWN, FEMALE
		db CURSE, RECOVER, PROTECT, SCALD
	db 80, BELLOSSOM, POWER_HERB, 252, DVS_HP_WATER, SHINY_MASK | ABILITY_1 | NAT_SATK_UP_ATK_DOWN, FEMALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 97, NINETALES, NEVERMELTICE, 252, FAKE_PERFECT_DVS, ABIL_NINETALES_ALOLAN_SNOW_WARNING | NAT_SPD_UP_ATK_DOWN, FEMALE | ALOLAN_FORM
		db BLIZZARD, MOONBLAST, PSYCHIC_M, WILL_O_WISP
	db 96, BLISSEY, BRIGHTPOWDER, 252, FAKE_PERFECT_DVS, ABIL_BLISSEY_SERENE_GRACE | NAT_SDEF_UP_ATK_DOWN, FEMALE
		db FRESH_SNACK, DOUBLE_TEAM, SWAGGER, CURSE
	db 98, RAPIDASH, PINK_BOW, 252, FAKE_PERFECT_DVS, ABIL_RAPIDASH_GALARIAN_PASTEL_VEIL | NAT_ATK_UP_SATK_DOWN, FEMALE | GALARIAN_FORM
		db MEGAHORN, PLAY_ROUGH, ZEN_HEADBUTT, SWORDS_DANCE
	db 99, CORSOLA, BRIGHTPOWDER, 252, FAKE_PERFECT_DVS, ABIL_CORSOLA_REGENERATOR | NAT_SDEF_UP_SPD_DOWN, FEMALE
		db CURSE, RECOVER, PROTECT, SCALD
if !DEF(FAITHFUL)
	db 98, KANGASKHAN, EXPERT_BELT, 252, FAKE_PERFECT_DVS, ABIL_KANGASKHAN_PARENTAL_BOND | NAT_ATK_UP_SATK_DOWN, FEMALE
		db DOUBLE_EDGE, EARTHQUAKE, IRON_TAIL, DRAIN_PUNCH
	db 100, CELEBI, LEFTOVERS, 252, FAKE_PERFECT_DVS, SHINY_MASK | ABIL_CELEBI_MAGIC_GUARD | NAT_SATK_UP_ATK_DOWN, FEMALE
		db NASTY_PLOT, PSYCHIC_M, AURA_SPHERE, ENERGY_BALL
else
	db 98, KANGASKHAN, EXPERT_BELT, 252, FAKE_PERFECT_DVS, ABIL_KANGASKHAN_INNER_FOCUS | NAT_ATK_UP_SATK_DOWN, FEMALE
		db DOUBLE_EDGE, EARTHQUAKE, IRON_TAIL, DRAIN_PUNCH
	db 100, CELEBI, LEFTOVERS, 252, FAKE_PERFECT_DVS, SHINY_MASK | ABIL_CELEBI_NATURAL_CURE | NAT_SATK_UP_ATK_DOWN, FEMALE
		db NASTY_PLOT, MOONBLAST, ENERGY_BALL, AURA_SPHERE
endc
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 49, MEGANIUM, MIRACLE_SEED, 64, FAKE_PERFECT_DVS, ABIL_MEGANIUM_OVERGROW | NAT_ATK_UP_SATK_DOWN, MALE
		db RAZOR_LEAF, DAZZLINGLEAM, GROWL, HEALINGLIGHT
	db 48, TYPHLOSION, CHARCOAL, 64, FAKE_PERFECT_DVS, ABIL_TYPHLOSION_BLAZE | NAT_SPD_UP_SATK_DOWN, MALE
		db FIRE_SPIN, DIG, LEER, SUNNY_DAY
	db 49, FERALIGATR, MYSTIC_WATER, 64, FAKE_PERFECT_DVS, ABIL_FERALIGATR_TORRENT | NAT_SPD_UP_SATK_DOWN, MALE
		db AQUA_JET, BITE, HEADBUTT, LEER
if !DEF(FAITHFUL)
	db 49, HERACROSS, SILVERPOWDER, 64, FAKE_PERFECT_DVS, ABIL_HERACROSS_MOXIE | NAT_SPD_UP_SATK_DOWN, MALE
		db BUG_BITE, BRICK_BREAK, TACKLE, CURSE
else
	db 49, HERACROSS, SILVERPOWDER, 64, FAKE_PERFECT_DVS, ABIL_HERACROSS_MOXIE | NAT_SPD_UP_SATK_DOWN, MALE
		db BUG_BITE, ROCK_SMASH, TACKLE, CURSE
endc
	db 50, NOCTOWL, SHARP_BEAK, 64, FAKE_PERFECT_DVS, SHINY_MASK | ABIL_NOCTOWL_TINTED_LENS | NAT_SATK_UP_ATK_DOWN, MALE
		db NIGHT_SHADE, DREAM_EATER, HYPNOSIS, WING_ATTACK
	db 51, PIKACHU, LIGHT_BALL, 64, FAKE_PERFECT_DVS, ABIL_PIKACHU_STATIC | NAT_SPD_UP_ATK_DOWN, MALE
...
; ================
	...
	; party
if !DEF(FAITHFUL)
	db 69, MEGANIUM, LEFTOVERS, 128, DVS_HP_ROCK, ABIL_MEGANIUM_NATURAL_CURE | NAT_ATK_UP_SATK_DOWN, MALE
		db SEED_BOMB, PLAY_ROUGH, EARTHQUAKE, GROWTH
else
	db 69, MEGANIUM, LEFTOVERS, 128, DVS_HP_ROCK, ABIL_MEGANIUM_OVERGROW | NAT_ATK_UP_SATK_DOWN, MALE
		db SEED_BOMB, PLAY_ROUGH, EARTHQUAKE, GROWTH
endc
	db 68, TYPHLOSION, LEFTOVERS, 128, DVS_HP_GRASS, ABIL_TYPHLOSION_FLASH_FIRE | NAT_SPD_UP_ATK_DOWN, MALE
		db FLAMETHROWER, EARTH_POWER, HIDDEN_POWER, FIRE_SPIN
	db 69, FERALIGATR, LEFTOVERS, 128, FAKE_PERFECT_DVS, ABIL_FERALIGATR_SHEER_FORCE | NAT_SPD_UP_SATK_DOWN, MALE
		db AQUA_TAIL, CRUNCH, ICE_PUNCH, LEER
	db 69, HERACROSS, EXPERT_BELT, 128, FAKE_PERFECT_DVS, ABIL_HERACROSS_MOXIE | NAT_SPD_UP_SATK_DOWN, MALE
		db MEGAHORN, CLOSE_COMBAT, STONE_EDGE, KNOCK_OFF
	db 70, NOCTOWL, WEAK_POLICY, 128, FAKE_PERFECT_DVS, SHINY_MASK | ABIL_NOCTOWL_TINTED_LENS | NAT_SATK_UP_ATK_DOWN, MALE
		db AIR_SLASH, SHADOW_BALL, CONFUSION, WING_ATTACK
	db 71, PIKACHU, LIGHT_BALL, 128, FAKE_PERFECT_DVS, ABIL_PIKACHU_STATIC | NAT_SPD_UP_SATK_DOWN, MALE
...
; ================
	...
	; party
if !DEF(FAITHFUL)
	db 89, MEGANIUM, LEFTOVERS, 252, DVS_HP_ROCK, ABIL_MEGANIUM_NATURAL_CURE | NAT_SPD_UP_ATK_DOWN, MALE
		db PETAL_DANCE, MOONBLAST, HIDDEN_POWER, CALM_MIND
else
	db 89, MEGANIUM, LEFTOVERS, 252, DVS_HP_ROCK, ABIL_MEGANIUM_OVERGROW | NAT_DEF_UP_ATK_DOWN, MALE
		db PETAL_DANCE, MOONBLAST, HIDDEN_POWER, CALM_MIND
endc
	db 88, TYPHLOSION, CHOICE_SPECS, 252, DVS_HP_GRASS, ABIL_TYPHLOSION_FLASH_FIRE | NAT_SPD_UP_SATK_DOWN, MALE
		db FLAMETHROWER, EARTH_POWER, HIDDEN_POWER, FOCUS_BLAST
	db 89, FERALIGATR, LIFE_ORB, 252, FAKE_PERFECT_DVS, ABIL_FERALIGATR_SHEER_FORCE | NAT_SPD_UP_SATK_DOWN, MALE
		db WATERFALL, CRUNCH, ICE_PUNCH, DRAGON_DANCE
	db 89, HERACROSS, EXPERT_BELT, 252, FAKE_PERFECT_DVS, ABIL_HERACROSS_SKILL_LINK | NAT_SPD_UP_SATK_DOWN, MALE
		db PIN_MISSILE, CLOSE_COMBAT, ROCK_BLAST, SWORDS_DANCE
	db 90, NOCTOWL, WEAK_POLICY, 252, FAKE_PERFECT_DVS, SHINY_MASK | ABIL_NOCTOWL_TINTED_LENS | NAT_SATK_UP_ATK_DOWN, MALE
		db CURSE, ROOST, PROTECT, HYPER_VOICE
	db 91, PIKACHU, LIGHT_BALL, 252, FAKE_PERFECT_DVS, ABIL_PIKACHU_STATIC | NAT_SPD_UP_SATK_DOWN, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 55, SMEARGLE, EXPERT_BELT, 252, DVS_HP_FLYING, ABIL_SMEARGLE_TECHNICIAN | NAT_SPD_UP_ATK_DOWN, FEMALE
		db CALM_MIND, HYPER_VOICE, DRAGONBREATH, HIDDEN_POWER
if !DEF(FAITHFUL)
	db 53, WEAVILE, EXPERT_BELT, 252, FAKE_PERFECT_DVS, ABIL_WEAVILE_TECHNICIAN | NAT_SPD_UP_SATK_DOWN, MALE
		db BITE, QUICK_ATTACK, ICE_SHARD, HONE_CLAWS
else
	db 53, WEAVILE, EXPERT_BELT, 252, FAKE_PERFECT_DVS, ABIL_WEAVILE_PRESSURE | NAT_SPD_UP_SATK_DOWN, MALE
		db BITE, QUICK_ATTACK, ICE_SHARD, HONE_CLAWS
		endc
	db 54, SCIZOR, EXPERT_BELT, 252, FAKE_PERFECT_DVS, ABIL_SCIZOR_TECHNICIAN | NAT_ATK_UP_SATK_DOWN, MALE
		db LEER, METAL_CLAW, BUG_BITE, AERIAL_ACE
	db 53, PERSIAN, EXPERT_BELT, 252, DVS_HP_DARK, ABIL_PERSIAN_ALOLAN_TECHNICIAN | NAT_SPD_UP_ATK_DOWN, FEMALE | ALOLAN_FORM
		db WATER_PULSE, POWER_GEM, HIDDEN_POWER, SWIFT
	db 54, MR__MIME, EXPERT_BELT, 252, FAKE_PERFECT_DVS, ABIL_MR__MIME_TECHNICIAN | NAT_SATK_UP_ATK_DOWN, MALE
		db CALM_MIND, DAZZLINGLEAM, CONFUSION, ENERGY_BALL 
	db 60, SMEARGLE, EXPERT_BELT, 252, FAKE_PERFECT_DVS, SHINY_MASK | ABIL_SMEARGLE_TECHNICIAN | NAT_ATK_UP_SATK_DOWN, MALE
...
; ================
	...
	; party
if !DEF(FAITHFUL)
	db 78, ARTICUNO, ICY_ROCK, 252, FAKE_PERFECT_DVS, ABIL_ARTICUNO_SNOW_WARNING | NAT_SATK_UP_ATK_DOWN, MALE
		db BLIZZARD, AEROBLAST, BUBBLE_BEAM, FLAMETHROWER
	db 79, ZAPDOS, DAMP_ROCK, 252, FAKE_PERFECT_DVS, ABIL_ZAPDOS_DRIZZLE | NAT_SATK_UP_ATK_DOWN, MALE
		db THUNDER, BUG_BUZZ, PSYCHIC_M, ENERGY_BALL
	db 79, MOLTRES, HEAT_ROCK, 252, FAKE_PERFECT_DVS, ABIL_MOLTRES_DROUGHT | NAT_SATK_UP_ATK_DOWN, MALE
		db FLAMETHROWER, SOLAR_BEAM, DARK_PULSE, DRAGON_PULSE
	db 79, SUICUNE, ASSAULT_VEST, 252, DVS_HP_STEEL, ABIL_SUICUNE_WATER_ABSORB | NAT_SATK_UP_ATK_DOWN, MALE
		db AURA_SPHERE, DARK_PULSE, HIDDEN_POWER, MOONBLAST
	db 79, ENTEI, LIFE_ORB, 252, FAKE_PERFECT_DVS, ABIL_ENTEI_FLASH_FIRE | NAT_ATK_UP_SATK_DOWN, MALE
		db SACRED_FIRE, EARTHQUAKE, GUNK_SHOT, HYPER_FANG
	db 78, RAIKOU, LEFTOVERS, 252, FAKE_PERFECT_DVS, ABIL_RAIKOU_VOLT_ABSORB | NAT_SATK_UP_ATK_DOWN, MALE
		db SHADOW_BALL, THUNDERBOLT, TRI_ATTACK, FUTURE_SIGHT
else
	db 78, ARTICUNO, EXPERT_BELT, 252, FAKE_PERFECT_DVS, ABIL_ARTICUNO_PRESSURE | NAT_SATK_UP_ATK_DOWN, FEMALE
		db BLIZZARD, AEROBLAST, BUBBLE_BEAM, FLAMETHROWER
	db 79, ZAPDOS, EXPERT_BELT, 252, FAKE_PERFECT_DVS, ABIL_ZAPDOS_PRESSURE | NAT_SATK_UP_ATK_DOWN, MALE
		db THUNDER, BUG_BUZZ, PSYCHIC_M, ENERGY_BALL
	db 79, MOLTRES, EXPERT_BELT, 252, FAKE_PERFECT_DVS, ABIL_MOLTRES_PRESSURE | NAT_SATK_UP_ATK_DOWN, MALE
		db FLAMETHROWER, SOLAR_BEAM, DARK_PULSE, DRAGON_PULSE
	db 79, SUICUNE, ASSAULT_VEST, 252, DVS_HP_STEEL, ABIL_SUICUNE_PRESSURE | NAT_SATK_UP_ATK_DOWN, MALE
		db AURA_SPHERE, DARK_PULSE, HIDDEN_POWER, MOONBLAST
	db 79, ENTEI, LIFE_ORB, 252, FAKE_PERFECT_DVS, ABIL_ENTEI_INNER_FOCUS | NAT_ATK_UP_SATK_DOWN, MALE
		db SACRED_FIRE, EARTHQUAKE, GUNK_SHOT, HYPER_FANG
	db 78, RAIKOU, LEFTOVERS, 252, FAKE_PERFECT_DVS, ABIL_RAIKOU_INNER_FOCUS | NAT_SATK_UP_ATK_DOWN, MALE
		db SHADOW_BALL, THUNDERBOLT, TRI_ATTACK, FUTURE_SIGHT
endc
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 100, PORYGON_Z, EXPERT_BELT, 252, FAKE_PERFECT_DVS, ABIL_PORYGON_Z_ANALYTIC | NAT_SATK_UP_SPD_DOWN, MALE
		db CALM_MIND, HYPER_VOICE, PSYSTRIKE, AURA_SPHERE
	db 105, TYRANITAR, EXPERT_BELT, 252, FAKE_PERFECT_DVS, ABIL_TYRANITAR_UNNERVE | NAT_ATK_UP_SATK_DOWN, MALE
		db MEGAHORN, STONE_EDGE, NIGHT_SLASH, SEED_BOMB
	db 110, DRAGONITE, EXPERT_BELT, 252, FAKE_PERFECT_DVS, ABIL_DRAGONITE_MULTISCALE | NAT_ATK_UP_SATK_DOWN, MALE
		db DRAGON_CLAW, WILD_CHARGE, PLAY_ROUGH, ZEN_HEADBUTT
	db 115, PORYGON2, EVIOLITE, 252, FAKE_PERFECT_DVS, ABIL_PORYGON2_ANALYTIC | NAT_SATK_UP_SPD_DOWN, MALE
		db NASTY_PLOT, FLAMETHROWER, ICE_BEAM, THUNDERBOLT
	db 120, GYARADOS, LIFE_ORB, 252, FAKE_PERFECT_DVS, SHINY_MASK | ABIL_GYARADOS_MOXIE | NAT_ATK_UP_SATK_DOWN, FEMALE | GYARADOS_RED_FORM
		db CRABHAMMER, BRAVE_BIRD, CLOSE_COMBAT, FLARE_BLITZ
	db 125, SHUCKLE, LEFTOVERS, 252, FAKE_PERFECT_DVS, ABIL_SHUCKLE_STURDY | NAT_SDEF_UP_SPD_DOWN, FEMALE
		db TOXIC, RECOVER, MUD_SLAP, WRAP
	db -1 ; end
...
; ================
	...
	; party
if DEF(FAITHFUL)
	db 97, MEGANIUM, LEFTOVERS, 252, DVS_HP_ROCK, ABIL_MEGANIUM_OVERGROW | NAT_SPD_UP_ATK_DOWN, MALE
		db PETAL_DANCE, MOONBLAST, HIDDEN_POWER, CALM_MIND
else
	db 49, MEGANIUM, LEFTOVERS, 252, DVS_HP_ROCK, ABIL_MEGANIUM_NATURAL_CURE | NAT_DEF_UP_ATK_DOWN, MALE
		db PETAL_DANCE, MOONBLAST, HIDDEN_POWER, CALM_MIND
endc
	db 48, TYPHLOSION, CHOICE_SPECS, 252, DVS_HP_GRASS, ABIL_TYPHLOSION_FLASH_FIRE | NAT_SPD_UP_SATK_DOWN, MALE
		db FLAMETHROWER, EARTH_POWER, HIDDEN_POWER, FOCUS_BLAST
	db 49, FERALIGATR, LIFE_ORB, 252, FAKE_PERFECT_DVS, ABIL_FERALIGATR_SHEER_FORCE | NAT_SPD_UP_SATK_DOWN, MALE
		db WATERFALL, CRUNCH, ICE_PUNCH, DRAGON_DANCE
	db 49, HERACROSS, EXPERT_BELT, 252, FAKE_PERFECT_DVS, ABIL_HERACROSS_SKILL_LINK | NAT_SPD_UP_SATK_DOWN,FEMALE
		db PIN_MISSILE, CLOSE_COMBAT, ROCK_BLAST, SWORDS_DANCE
	db 50, NOCTOWL, WEAK_POLICY, 252, FAKE_PERFECT_DVS, SHINY_MASK | ABIL_NOCTOWL_TINTED_LENS | NAT_SATK_UP_ATK_DOWN, MALE
		db CURSE, RECOVER, PROTECT, SCALD
	db 51, PIKACHU, LIGHT_BALL, 252, FAKE_PERFECT_DVS, ABIL_PIKACHU_STATIC | NAT_SPD_UP_ATK_DOWN, MALE
		db WILD_CHARGE, IRON_TAIL, EXTREMESPEED, DIG
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 52, CLEFABLE, LUM_BERRY, 128, FAKE_PERFECT_DVS, ABIL_CLEFABLE_MAGIC_GUARD | NAT_SATK_UP_ATK_DOWN, FEMALE
		db DAZZLINGLEAM, METRONOME, CURSE, HEALINGLIGHT
	db 53, KADABRA, EVIOLITE, 128, FAKE_PERFECT_DVS, ABIL_KADABRA_SYNCHRONIZE | NAT_SATK_UP_ATK_DOWN, MALE
		db PSYCHIC_M, CALM_MIND, THUNDER_WAVE, SHADOW_BALL 
	db 52, NINETALES, CHARCOAL, 128, FAKE_PERFECT_DVS, ABILITY_2 | NAT_SPD_UP_ATK_DOWN, FEMALE
		db SHADOW_BALL, EXTRASENSORY, FLAMETHROWER, CONFUSE_RAY
	db 51, ESPEON, LEFTOVERS, 128, FAKE_PERFECT_DVS, ABIL_ESPEON_MAGIC_BOUNCE | NAT_SPD_UP_ATK_DOWN, MALE
		db PSYBEAM, HEALINGLIGHT, SUBSTITUTE, SWIFT
	db 51, SYLVEON, PINK_BOW, 128, FAKE_PERFECT_DVS, SHINY_MASK | ABIL_SYLVEON_CUTE_CHARM | NAT_SATK_UP_ATK_DOWN, FEMALE
		db DAZZLINGLEAM, LIGHT_SCREEN, REFLECT, DRAIN_KISS
	db 55, XATU, KINGS_ROCK, 128, DVS_HP_GROUND, ABIL_XATU_MAGIC_BOUNCE | NAT_SPD_UP_ATK_DOWN, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 74, CLEFABLE, LUM_BERRY, 200, FAKE_PERFECT_DVS, ABIL_CLEFABLE_MAGIC_GUARD | NAT_SATK_UP_ATK_DOWN, FEMALE
		db MOONBLAST, METRONOME, MINIMIZE, HEALINGLIGHT
	db 75, ALAKAZAM, QUICK_CLAW, 200, FAKE_PERFECT_DVS, ABIL_ALAKAZAM_SYNCHRONIZE | NAT_SATK_UP_ATK_DOWN, MALE
		db PSYBEAM, CALM_MIND, THUNDERBOLT, SHADOW_BALL 
	db 52, NINETALES, CHARCOAL, 128, FAKE_PERFECT_DVS, ABILITY_2 | NAT_SPD_UP_ATK_DOWN, FEMALE
		db PSYCHIC_M, NASTY_PLOT, FIRE_BLAST, WILL_O_WISP
	db 74, ESPEON, LEFTOVERS, 200, FAKE_PERFECT_DVS, ABIL_ESPEON_MAGIC_BOUNCE | NAT_SPD_UP_ATK_DOWN, MALE
		db PSYCHIC_M, HEALINGLIGHT, SUBSTITUTE, POWER_GEM
	db 76, SYLVEON, PINK_BOW, 200, FAKE_PERFECT_DVS, SHINY_MASK | ABIL_SYLVEON_CUTE_CHARM | NAT_SATK_UP_ATK_DOWN, FEMALE
		db MOONBLAST, LIGHT_SCREEN, REFLECT, TOXIC
	db 77, XATU, KINGS_ROCK, 200, FAKE_PERFECT_DVS, ABIL_XATU_MAGIC_BOUNCE | NAT_SPD_UP_ATK_DOWN, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 97, CLEFABLE, LUM_BERRY, 252, FAKE_PERFECT_DVS, ABIL_CLEFABLE_MAGIC_GUARD | NAT_SATK_UP_ATK_DOWN, FEMALE
		db MOONBLAST, METRONOME, MINIMIZE, HEALINGLIGHT
	db 96, ALAKAZAM, QUICK_CLAW, 252, FAKE_PERFECT_DVS, ABIL_ALAKAZAM_SYNCHRONIZE | NAT_SATK_UP_ATK_DOWN, MALE
		db PSYCHIC_M, CALM_MIND, THUNDER_WAVE, SHADOW_BALL 
	db 96, NINETALES, NEVERMELTICE, 252, FAKE_PERFECT_DVS, ABIL_NINETALES_ALOLAN_SNOW_CLOAK | NAT_SPD_UP_ATK_DOWN, FEMALE
		db BLIZZARD, HAIL, DAZZLINGLEAM, CONFUSE_RAY
	db 97, ESPEON, LEFTOVERS, 252, FAKE_PERFECT_DVS, ABIL_ESPEON_MAGIC_BOUNCE | NAT_SPD_UP_ATK_DOWN, MALE
		db PSYCHIC_M, HEALINGLIGHT, SUBSTITUTE, POWER_GEM
	db 97, SYLVEON, PINK_BOW, 252, FAKE_PERFECT_DVS, SHINY_MASK | ABIL_SYLVEON_CUTE_CHARM | NAT_SATK_UP_ATK_DOWN, FEMALE
		db MOONBLAST, LIGHT_SCREEN, REFLECT, TOXIC
	db 98, LUGIA, KINGS_ROCK, 252, FAKE_PERFECT_DVS, ABIL_LUGIA_MULTISCALE | NAT_SPD_UP_ATK_DOWN, MALE
