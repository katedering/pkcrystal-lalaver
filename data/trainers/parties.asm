...
; ================
	...
	; party
if !DEF(FAITHFUL)
	db 94, MEGANIUM, LEFTOVERS, 252, DVS_HP_ROCK, ABIL_MEGANIUM_NATURAL_CURE | NAT_SPD_UP_ATK_DOWN, MALE
		db PETAL_DANCE, MOONBLAST, HIDDEN_POWER, CALM_MIND
else
	db 94, MEGANIUM, LEFTOVERS, 252, DVS_HP_ROCK, ABIL_MEGANIUM_OVERGROW | NAT_DEF_UP_ATK_DOWN, MALE
		db PETAL_DANCE, MOONBLAST, HIDDEN_POWER, CALM_MIND
endc
	db 94, TYPHLOSION, CHOICE_SPECS, 252, DVS_HP_GRASS, ABIL_TYPHLOSION_FLASH_FIRE | NAT_SPD_UP_SATK_DOWN, MALE
		db FLAMETHROWER, EARTH_POWER, HIDDEN_POWER, FOCUS_BLAST
	db 94, FERALIGATR, LIFE_ORB, 252, FAKE_PERFECT_DVS, ABIL_FERALIGATR_SHEER_FORCE | NAT_SPD_UP_SATK_DOWN, MALE
		db WATERFALL, CRUNCH, ICE_PUNCH, DRAGON_DANCE
	db 94, HERACROSS, EXPERT_BELT, 252, FAKE_PERFECT_DVS, ABIL_HERACROSS_SKILL_LINK | NAT_SPD_UP_SATK_DOWN, MALE
		db PIN_MISSILE, CLOSE_COMBAT, ROCK_BLAST, SWORDS_DANCE
	db 95, NOCTOWL, WEAK_POLICY, 252, FAKE_PERFECT_DVS, SHINY_MASK | ABIL_NOCTOWL_TINTED_LENS | NAT_SATK_UP_ATK_DOWN, MALE
		db CURSE, ROOST, PROTECT, HYPER_VOICE
	db 96, PIKACHU, LIGHT_BALL, 252, FAKE_PERFECT_DVS, ABIL_PIKACHU_STATIC | NAT_SPD_UP_SATK_DOWN, MALE
...
; ================
	...
	db 72, NINETALES, CHARCOAL, 128, FAKE_PERFECT_DVS, ABILITY_2 | NAT_SPD_UP_ATK_DOWN, FEMALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_MOVES
	; party
	db 250, BLISSEY, TOXIC_ORB
		db SPLASH, PAIN_SPLIT, NO_MOVE, NO_MOVE
	db 250, BLISSEY, TOXIC_ORB
		db SPLASH, PAIN_SPLIT, NO_MOVE, NO_MOVE
	db 250, BLISSEY, TOXIC_ORB
		db SPLASH, PAIN_SPLIT, NO_MOVE, NO_MOVE
